    ...
    <PageTransition>
      <div className="min-h-screen bg-white pt-20">
        ...
        <section className="section mesh-gradient">
          <div className="container-premium text-center px-4 sm:px-6">
            <ScrollReveal>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-playfair font-bold text-gray-900 mb-4 sm:mb-6" style={{lineHeight: '1.6', letterSpacing: '0.04em'}}>
                About Us
              </h1>
      ...
      <section className="section">
        <div className="container-premium max-w-4xl px-4 sm:px-6">
          <ScrollReveal>
            <div className="card-premium hover-lift p-5 sm:p-8 md:p-12">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-playfair font-bold text-gray-900 mb-4 sm:mb-6">
            ...
            {[
              ...
              <ScrollReveal key={index} delay={index * 0.1} className="relative">
                <div className="card-premium hover-lift p-4 sm:p-6 text-center h-full">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-accent-gold text-white flex items-center justify-center font-bold text-lg sm:text-xl mx-auto mb-3 sm:mb-4">
                    {item.step}
                  </div>
      ...
      <section className="section" id="ceo-message">
        <div className="container max-w-6xl px-4 sm:px-6">
          ...
          <ScrollReveal delay={0.2}>
            <div className="card p-5 sm:p-8 md:p-12 mb-6 sm:mb-8">
          ...
          <ScrollReveal delay={0.4}>
            <div className="card p-5 sm:p-8 mt-6 sm:mt-8">
